...
time_t neb::GetCurrentTime()
{
    return time(NULL);
}

std::string neb::GetCurrentTime(int iTimeSize)
{
        ...
        const std::string& strTimeFormat)
{
    ...
    if ("YYYY-MM-DD HH:MI:SS" == strTimeFormat || "yyyy-mm-dd hh:mi:ss"
            ...
            || "%Y-%m-%d" == strTimeFormat)
    {
        return neb::TimeStr2time_t(strTime.c_str());
    }
            ...
            == strTimeFormat || "%Y%m%d%H%M%S" == strTimeFormat)
    {
        osStream << strTime[0] << strTime[1] << strTime[2]
                ...
                << strTime[13];
        return neb::TimeStr2time_t(osStream.str().c_str());
    }
...
time_t neb::TimeStr2time_t(const char *szTimeStr)
{
    int iYear = 1971;
    int iMonth = 1;
    int iDay = 1;
...
const std::string neb::time_t2TimeStr(
        time_t lTime,
        const std::string& strTimeFormat)
{
    char szTime[20] = {0};
        ...
        const std::string& strTimeFormat2)
{
    ...
    lTime1 = neb::TimeStr2time_t(strTime1, strTimeFormat1);
    lTime2 = neb::TimeStr2time_t(strTime2, strTimeFormat2);
    lSeconds = lTime2 - lTime1;
    return (lSeconds > 0)?(lSeconds):(lSeconds * -1);
}

time_t neb::GetBeginTimeOfTheHour(time_t lTime)
{
...
const std::string neb::GetBeginTimeOfTheHour(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime = 0;
    time_t lHourBeginTime = 0;
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lHourBeginTime = neb::GetBeginTimeOfTheHour(lTime);
    return neb::time_t2TimeStr(lHourBeginTime, strTimeFormat);
}

time_t neb::GetEndTimeOfTheHour(time_t lTime)
{
...
const std::string neb::GetEndTimeOfTheHour(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime = 0;
    time_t lHourEndTime = 0;
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lHourEndTime = neb::GetEndTimeOfTheHour(lTime);
    return neb::time_t2TimeStr(lHourEndTime, strTimeFormat);
}

time_t neb::GetBeginTimeOfTheDay(time_t lTime)
{
...
const std::string neb::GetBeginTimeOfTheDay(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime = 0;
    time_t lDayBeginTime = 0;
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lDayBeginTime = neb::GetBeginTimeOfTheDay(lTime);
    return neb::time_t2TimeStr(lDayBeginTime, strTimeFormat);
}

time_t neb::GetEndTimeOfTheDay(time_t lTime)
{
    struct tm stTime;
    time_t lDayEndTime;
...
const std::string neb::GetEndTimeOfTheDay(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime = 0;
    ...
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lDayEndTime = neb::GetEndTimeOfTheDay(lTime);
    return neb::time_t2TimeStr(lDayEndTime, strTimeFormat);
}

time_t neb::GetBeginTimeOfTheWeek(time_t lTime)
{
    struct tm stTime;
...
const std::string neb::GetBeginTimeOfTheWeek(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime = 0;
    ...
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lWeekBeginTime = neb::GetBeginTimeOfTheWeek(lTime);
    return neb::time_t2TimeStr(lWeekBeginTime, strTimeFormat);
}

time_t neb::GetBeginTimeOfTheMonth(time_t lTime)
{
    struct tm stTime;
...
const std::string neb::GetBeginTimeOfTheMonth(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime = 0;
    ...
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lMonthBeginTime = neb::GetBeginTimeOfTheMonth(lTime);
    return neb::time_t2TimeStr(lMonthBeginTime, strTimeFormat);
}

time_t neb::GetEndTimeOfTheMonth(time_t lTime)
{
    struct tm stTime;
...
const std::string neb::GetEndTimeOfTheMonth(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime = 0;
    ...
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lMonthEndTime = neb::GetEndTimeOfTheMonth(lTime);
    return neb::time_t2TimeStr(lMonthEndTime, strTimeFormat);
}

time_t neb::GetBeginTimeOfNextMonth(time_t lTime)
{
    struct tm stTime;
    time_t lMonthBeginTime;
...
const std::string neb::GetBeginTimeOfNextMonth(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime = 0;
    time_t lMonthEndTime = 0;
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lMonthEndTime = neb::GetBeginTimeOfNextMonth(lTime);
    return neb::time_t2TimeStr(lMonthEndTime, strTimeFormat);
}

time_t neb::GetDaysBefore(
        time_t lTime,
        int iDaysBefore)
{
...
const std::string neb::GetDaysBefore(
        const std::string& strTime,
        int iDaysBefore,
        const std::string& strTimeFormat)
{
    ...
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    lDaysBefore = neb::GetDaysBefore(lTime, iDaysBefore);
    return neb::time_t2TimeStr(lDaysBefore, strTimeFormat);
}

int neb::GetTotalDaysOfTheMonth(time_t lTime)
{
    time_t lLastMoment = neb::GetEndTimeOfTheMonth(lTime);
    struct tm stTime;
...
int neb::GetTotalDaysOfTheMonth(
        const std::string& strTime,
        const std::string& strTimeFormat)
{
    time_t lTime;
    lTime = neb::TimeStr2time_t(strTime, strTimeFormat);
    return neb::GetTotalDaysOfTheMonth(lTime);
}

unsigned long long neb::GetMicrosecond()
{
    timeval stTime;
